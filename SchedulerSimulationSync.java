...
class SharedResources {
    ...
    // Example: public static final ReentrantLock lock = new ReentrantLock();
     //   grained locks for independent counters
    public static final ReentrantLock contextSwitchCountLock = new ReentrantLock();
    ...
    // Example: public static final Semaphore cpuSemaphore = new Semaphore(1);
        // binary semaphore for CPU  control
    ...
    public void runToCompletion() {
        ...
        try {
            ...
            System.out.println();
                ...
                SharedResources.cpuSemaphore.release(); // to releswe CPU after completion
            }
        } catch (InterruptedException e) {
